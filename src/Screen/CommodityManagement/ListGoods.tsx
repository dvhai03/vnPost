...
import IconAdd2 from '../../../asset/svg/iconAdd2';
import IconAdd from '../../../asset/svg/iconAdd';
import Search from '../../../asset/svg/search';
import ButtonIcon from '../../components/ButtonIcon';
import Popup from '../../../asset/svg/popup';
import List0 from '../../../asset/svg/list0';

import { FlatList } from 'react-native-gesture-handler';
import AddListHC from '../../../asset/svg/addListHC';
...
import Listgoods from '../../../asset/svg/listgoods';
...
const data: MyList[] = [
    { id: 1, name: 'Thùng bia Tiger 24 lon', sdt: 1200, dress: '30 X 30 x 30', status: 240, uri: '../../../asset/png/avataHanghoa.png' },
    { id: 2, name: 'Thùng bia Tiger 24 lon', sdt: 1200, dress: '30 X 30 x 30', status: 240, uri: '../../../asset/png/avataHanghoa.png' },
    { id: 3, name: 'Thùng bia Tiger 24 lon', sdt: 1200, dress: '30 X 30 x 30', status: 240, uri: '../../../asset/png/avataHanghoa.png' },
    { id: 4, name: 'Thùng bia Tiger 24 lon', sdt: 1200, dress: '30 X 30 x 30', status: 240, uri: '../../../asset/png/avataHanghoa.png' },
    { id: 5, name: 'Thùng bia Tiger 24 lon', sdt: 1200, dress: '30 X 30 x 30', status: 240, uri: '../../../asset/png/avataHanghoa.png' },
    { id: 6, name: 'Thùng bia Tiger 24 lon', sdt: 1200, dress: '30 x 30 x 30', status: 240, uri: '../../../asset/png/avataHanghoa.png' },
                            ...
                            <View
                                ...
                                <View style={{ width: '70%', flexDirection: 'row' }} >
                                    <View style={{ marginVertical: 5 }}>
                                        <Image
                                            source={require('../../../asset/png/avataHanghoa.png')} // Replace with your image path
