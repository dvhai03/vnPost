...
import Lock from '../../asset/svg/lock';
...
import Icon1 from '../../asset/svg/icon1';
import icon1 from '../../asset/svg/icon1';
import spinner from '../../asset/svg/spinner';
import icon2 from '../../asset/svg/icon2';
import icon3 from '../../asset/svg/icon3';
import icon4 from '../../asset/svg/icon4';
import popup from '../../asset/svg/popup';
import spinner2 from '../../asset/svg/spinner2';
import Switch from '../components/Switch';
import Iconhopdong from '../../asset/svg/iconhopdong';
import { KeyboardAvoidingView, Platform } from 'react-native';
import ButtonIcon from '../components/ButtonIcon';
import add from '../../asset/svg/add';
import iconAdd from '../../asset/svg/iconAdd2';
