...
import IconNotifi from '../../../../asset/svg/iconNotifi';
import IconQR from '../../../../asset/svg/iconQR';
import IconCreatebill from '../../../../asset/svg/iconCreatebill';
import IconManager from '../../../../asset/svg/iconManager';
import IconThongke from '../../../../asset/svg/iconThongke';
import IconQuanLiDon from '../../../../asset/svg/iconQuanLiDon';
import IconDonHangXiLi from '../../../../asset/svg/iconDonHangXiLi';
import IconHistory from '../../../../asset/svg/iconHistory';
import IconLoHang from '../../../../asset/svg/iconLoHang';
import IconNhanDon from '../../../../asset/svg/iconNhanDon';
import IconChinhDon from '../../../../asset/svg/iconChinhDon';
import IconQuanLiNhap from '../../../../asset/svg/iconQuanLiNhap';
import IconThuGom from '../../../../asset/svg/iconThuGom';
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={{ width: '100%', height: '50%', marginBottom: 70 }}>
                <ImageBackground
                    source={require('../../../../asset/png/backgoundhome.png')} // Đường dẫn đến tệp ảnh của bạn
                    style={{
                        flex: 1,
                        width: '100%',
                        paddingTop: 10
                ...
                >
                    <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', height: '20%' }}>
                        <Image
                            source={require('../../../../asset/png/avata.png')}
                    ...
                    <View style={{ width: '100%', height: '100%', alignItems: 'flex-end', flexDirection: 'row' }}>
                        ...
                        <TouchableOpacity style={styles.box}>
                            <IconManager />
                            <Text style={[commonStyles.text_14, { fontWeight: '800', marginTop: 10 }]}>Quản lí đơn hàng gửi</Text>
                        </TouchableOpacity>
                    </View>
                </ImageBackground>
