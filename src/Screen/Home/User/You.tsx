...
import User from '../../../../asset/svg/You/user';
import Pass from '../../../../asset/svg/You/pass';
import Notifation from '../../../../asset/svg/You/notifation';
import InDon from '../../../../asset/svg/You/in';
import ThietLap from '../../../../asset/svg/You/thietLap';
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={commonStyles.tool_bar}>
                <View style={{ width: '15%' }}>
                    <ImageBackground
                        source={require('../../../../asset/png/avata.png')} // Đường dẫn đến tệp ảnh của bạn
