...
import Capcha from '../../asset/svg/capcha';
import { Divider, TextInput } from 'react-native-paper';
import { TouchableOpacity } from 'react-native';
import capcha from '../../asset/svg/capcha';
import eye_slash from '../../asset/svg/eye-slash';
import One from '../../asset/svg/login/1';
import Hai from '../../asset/svg/login/2';
import Three from '../../asset/svg/login/3';
import Bon from '../../asset/svg/login/4';
import Five from '../../asset/svg/login/5';
import Six from '../../asset/svg/login/6';
import Seven from '../../asset/svg/login/7';
import Eat from '../../asset/svg/login/8';
  ...
  return (
    <View style={{ flex: 1 }}>
      <SafeAreaView style={styles.container}>
        ...
        <TouchableOpacity onPress={() => { navigation.navigate('ChooseOrganization') }} style={[commonStyles.view_alignItem, { marginBottom: 8 }]}>
